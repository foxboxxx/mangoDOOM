...
int EV_DoDonut(line_t*	line)
{
	...
	s2 = getNextSector(s1->lines[0],s1);
        ...
        if (s2 == NULL)
        {
			...
			printf("EV_DoDonut: linedef had no second sidedef! Unexpected behavior may occur in Vanilla Doom. \n");
	    break;
        }
	...
	for (i = 0; i < s2->linecount; i++)
	{
		...
		continue;
            ...
            if (s3 == NULL)
            {
                ...
                //         "NULL back sector. "
                //         "Unexpected behavior may occur in Vanilla Doom.\n");
				printf("EV_DoDonut: WARNING: emulating buffer overrun due to NULL back sector. Unexpected behavior may occur in Vanilla Doom.\n");
