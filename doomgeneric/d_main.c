...
void D_Display(void) {
    ...
    if (gamestate != wipegamestate) {
        // printf("%s: Wipe set to true\n", __FUNCTION__);
        wipe = true;
        wipe_StartScreen(0, 0, SCREENWIDTH, SCREENHEIGHT);
    } else {
        // printf("%s: Wipe set to false\n", __FUNCTION__);
        wipe = false;
    }
    ...
    if (gamestate == GS_LEVEL && gametic) {
        // printf("%s: Called HU_Drawer()\n", __FUNCTION__);
        HU_Drawer();
    }

    // clean up border stuff
    if (gamestate != oldgamestate && gamestate != GS_LEVEL) {
        // printf("%s: Called I_SetPalette()\n", __FUNCTION__);
        I_SetPalette(W_CacheLumpName(DEH_String("PLAYPAL"), PU_CACHE));
    }

    // see if the border needs to be initially drawn
    if (gamestate == GS_LEVEL && oldgamestate != GS_LEVEL) {
        // printf("%s: Called R_FillBackScreen()\n", __FUNCTION__);
    ...
    //-----------------------------------------------//
    // patch_t* patch_print = W_CacheLumpName("TITLEPIC", PU_CACHE); // STDISK
    // V_DrawPatch(10, 10, patch_print); 
    //---------------------------------------------------------------------//
...
static boolean D_AddFile(/*char *filename*/void) {
...
void D_DoomMain(void) {
    ...
    // Using raw DOOM Ultimate, not needed
    modifiedgame = false;

    DEH_printf("W_Init: Init WADfiles.\n");
    printf("Actual WAD array is at: %p\n", DOOM_WAD);
    D_AddFile(/*iwadfile*/);
    ...
    printf("%s: Post GenerateHashTable()\n", __FUNCTION__);
    ...
    printf("%s: Post I_CheckIsScreensaver()\n", __FUNCTION__);
    I_InitTimer();
    printf("%s: Post I_InitTimer()\n", __FUNCTION__);
    I_InitJoystick();
    printf("%s: Post I_InitJoystick()\n", __FUNCTION__);
    I_InitSound(true);
    printf("%s: Post I_InitSound()\n", __FUNCTION__);
    I_InitMusic();
    printf("%s: Post I_InitMusic()\n", __FUNCTION__);
